...
export default function Settings(){
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content}>
  ...
  <View style={s.profile}><View style={s.avatar}><Text style={s.avatarText}>7</Text></View><View><Text style={s.name}>Seven Music</Text><Text style={s.tagline}>Sua música. Sem limites.</Text></View></View>
  ...
  <View style={s.version}><View style={s.smallLogo}><Text style={s.smallLogoText}>7</Text></View><View style={{flex:1}}><Text style={s.versionTitle}>Seven Music v0.1.0</Text><Text style={s.versionSub}>Feito por quem vive música.</Text></View><MaterialCommunityIcons name="heart" size={22} color={C.danger}/></View>
...
const s=StyleSheet.create({
 ...
 avatarText:{color:C.purple,fontSize:48,fontStyle:'italic',fontWeight:'900'},name:{color:C.text,fontSize:18,fontWeight:'900'},tagline:{color:C.muted,fontSize:11.5,marginTop:4},
 ...
 smallLogo:{width:42,height:42,borderRadius:12,backgroundColor:'#1A0F2A',alignItems:'center',justifyContent:'center'},smallLogoText:{color:C.purple,fontSize:30,fontStyle:'italic',fontWeight:'900'},
