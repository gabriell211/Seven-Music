...
export default function Settings(){
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content}>
  ...
  <View style={s.version}><View style={s.smallLogo}><SevenMark size={29}/></View><View style={{flex:1}}><Text style={s.versionTitle}>Seven Music v0.2.2</Text><Text style={s.versionSub}>Feito por quem vive música.</Text></View><MaterialCommunityIcons name="heart" size={22} color={C.danger}/></View>
